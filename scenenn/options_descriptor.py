...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', default='/ssd/USIP_datasets/SceneNN-DS-compact', help='path to images & laser point clouds')
        ...
        self.parser.add_argument('--node_knn_k_1', type=int, default=4, help='k nearest neighbor of SOM nodes searching on SOM nodes')
        ...
        self.parser.add_argument('--rot_perturbation', type=bool, default=True, help='Small rotation augmentation around 3 axis.')
        ...
        # descriptor
        self.parser.add_argument('--ball_radius', type=int, default=0.75, help='Ball query around each keypoint')
        self.parser.add_argument('--ball_nsamples', type=int, default=448, help='Ball query around each keypoint')
        self.parser.add_argument('--descriptor_len', type=float, default=128, help='length of descriptor')

        # DescCGFLoss
        self.parser.add_argument('--CGF_radius', type=float, default=0.075, help='CGF Threshold to determine positive match')

        # triplet loss
        self.parser.add_argument('--sigma_max', type=float, default=0.5, help='same as detector option keypoint_outlier_thre')
        self.parser.add_argument('--triple_loss_gamma', type=float, default=0.3, help='')
        ...
        self.parser.add_argument('--scene', type=str, default='indoor', help='outdoor / indoor / object')
