...
function [Rt, inliers, trialcount] = ransacfitRt(x, t, feedback, maxTrials)
    if nargin < 4; maxTrials = 10000;    end;
    ...
    [Rt, inliers, trialcount] = ransac(x, fittingfn, distfn, degenfn, s, t, feedback, 1000, maxTrials);
