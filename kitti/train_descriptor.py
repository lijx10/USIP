...
from data.kitti_descriptor_loader import KittiDescriptorLoader
...
if __name__=='__main__':
    ...
    testset = KittiDescriptorLoader(opt_descriptor.dataroot, 'test', opt_descriptor)
    ...
    model_detector.detector.load_state_dict(
        model_state_dict_convert_auto(
            torch.load(
                '/ssd/tsf/kitti/checkpoints/save/detector/' + folder_name + '/best.pth',
    ...
    for epoch in range(501):
        ...
        for i, data in enumerate(trainloader):
            ...
            # get neg_idx
            neg_idx = trainset.mine_negative_sample(anc_seq, anc_pose, opt_descriptor.negative_radius_threshold)
        ...
        if epoch >= 0 and epoch%1==0:
            ...
            for i, data in enumerate(testloader):
                ...
                # get neg_idx
                neg_idx = testset.mine_negative_sample(anc_seq, anc_pose, opt_descriptor.negative_radius_threshold)
