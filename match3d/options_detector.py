...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset', type=str, default='3dmatch', help='kitti')
        self.parser.add_argument('--dataroot', default='/data/datasets/3DMatch_npy', help='path to images & laser point clouds')
        ...
        self.parser.add_argument('--keypoint_on_pc_alpha', type=float, default=10, help='weight of keypoint_on_pc loss, default 0.5.')
