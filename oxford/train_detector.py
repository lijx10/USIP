...
from oxford.options_detector import Options
...
from data.oxford_detector_loader import OxfordLoader
...
if __name__=='__main__':
    ...
    for epoch in range(501):
        ...
        if epoch >= 0 and epoch%1==0:
            ...
            # save models
            # if (model.test_loss_average.item() <= best_loss + 1e-5) and (model.test_chamfer_pure_average.item() < 50) and (epoch>2*lr_decay_step):
            if True:
